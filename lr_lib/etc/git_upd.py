...
VersionChanges = collections.OrderedDict({
    'v11.5.6': '''
* неверно работал "Поиск WRSP" №5 и №6, если он производился кнопкой "Запуск" из меню "Найти и Создать WRSP",
    не использовались, найденные перед этим другими способоми, но еще не созданные param
    ''',
    'v11.5.5': '''
