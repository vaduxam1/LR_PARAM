...
VersionChanges = collections.OrderedDict({
    ...
    'v11.6.4': '''
* Утилита стала "portable"- добавлен запускающий файл lr_start.cmd. При его запуске, если python не установлен, произойден автоустановка python 3.4.4. Также можно использовать сторонние библиотеки, произойдет автоустановка офлайн whl файлов из каталога lr_lib\whl\install\
