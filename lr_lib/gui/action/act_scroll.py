...
class ActScrollText(lr_lib.gui.action.act_widj.ActWidj):
    ...
    def __init__(self):
        ...
        self.tk_text = lr_lib.gui.widj.highlight_text.HighlightText(self, background=lr_lib.core.var.vars_h.Background, wrap=tk.NONE, bd=0)
        ...
        self.highlight_cbx = tk.Checkbutton(
            self.cbx_bar, text='highlight', font=lr_vars.DefaultFont, background=lr_lib.core.var.vars_h.Background,
        ...
        self.highlight_After0.insert(0, lr_lib.core.var.vars_h.HighlightAfter0)
        self.highlight_After1.insert(0, lr_lib.core.var.vars_h.HighlightAfter1)
        self.highlight_After2.insert(0, lr_lib.core.var.vars_h.HighlightAfter2)
        return
